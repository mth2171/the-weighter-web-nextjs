  ...
  return (
    <CommonLayout>
      ...
      <Modal open={modalOpen}>
        <Box className="absolute top-[12%] left-[12%] w-3/4 h-3/4 bg-white border-black border-2 rounded-xl shadow-shadow">
          <div className="flex w-full h-full justify-center items-center flex-col">
            <div className="absolute right-5 top-4 cursor-pointer" onClick={() => setModalOpen(!modalOpen)}>
            ...
            <div className="flex w-full p-3 flex-col">
              <div className="flex w-full flex-row border-black border">
              ...
              {modalData &&
                modalData.map((value, index) => {
                  return (
                    <div key={index} className="flex flex-row border-black border-b border-x">
                      ...
                      <div className="flex p-3 h-14 w-[10%] justify-center items-center">
                        <button
                          className="flex h-full px-3 bg-button text-white rounded-lg justify-center items-center"
                          onClick={() => {
